<template>
  <div class="relative">
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div class="absolute top-20 left-10 w-32 h-32 bg-blue-100 rounded-full opacity-50 animate-pulse"></div>
      <div class="absolute bottom-20 right-10 w-24 h-24 bg-purple-100 rounded-full opacity-50 animate-pulse delay-1000"></div>
      <div class="absolute top-1/2 left-1/4 w-16 h-16 bg-pink-100 rounded-full opacity-30 animate-bounce delay-500"></div>
      ...
      <div class="relative z-10 container mx-auto px-6 text-center">
        <div class="max-w-4xl mx-auto">
          <!-- Profile Image -->
          <div class="mb-8">
            <div class="w-32 h-32 mx-auto bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center shadow-2xl ring-4 ring-white">
          ...
          <h2 class="text-2xl md:text-3xl text-slate-600 mb-8 font-light">
            Engineering Manager & Full-Stack Developer
          </h2>
          
          <!-- Description -->
          <p class="text-lg md:text-xl text-slate-600 leading-relaxed mb-12 max-w-3xl mx-auto">
            バックエンド開発を軸とした技術マネジメントとフルスタック開発に従事。<br>
            10年以上の開発経験を活かし、チーム育成と技術革新を推進しています。
          </p>
      ...
      <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <font-awesome-icon icon="chevron-down" class="text-slate-400 text-xl" />
      </div>
    </section>
    ...
    <section class="py-20 bg-white">
      <div class="container mx-auto px-6">
        <div class="max-w-4xl mx-auto text-center">
          <h3 class="text-3xl font-bold text-slate-800 mb-12">What I Do</h3>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="overview-card">
              ...
              <h4 class="text-xl font-semibold text-slate-800 mb-4">Engineering Management</h4>
              <p class="text-slate-600">チーム育成、技術戦略立案、プロジェクトマネジメントを通じて組織の成長を支援</p>
            </div>
            
            <!-- Backend Development -->
            <div class="overview-card">
              <div class="w-16 h-16 bg-purple-100 rounded-xl flex items-center justify-center mb-6 mx-auto">
                <font-awesome-icon icon="server" class="text-purple-600 text-2xl" />
              </div>
              <h4 class="text-xl font-semibold text-slate-800 mb-4">Backend Development</h4>
              <p class="text-slate-600">PHP、Go、Java等を用いたスケーラブルなWebアプリケーション・API開発</p>
            </div>
            
            <!-- Full-Stack Development -->
            <div class="overview-card">
              <div class="w-16 h-16 bg-pink-100 rounded-xl flex items-center justify-center mb-6 mx-auto">
                <font-awesome-icon icon="laptop-code" class="text-pink-600 text-2xl" />
              </div>
              <h4 class="text-xl font-semibold text-slate-800 mb-4">Full-Stack Development</h4>
              <p class="text-slate-600">フロントエンドからバックエンドまで一貫したWebアプリケーション開発</p>
            </div>
          </div>
        </div>
      </div>
...
.hero-btn-secondary:hover {
  ...
  color: white;
  transform: translateY(-2px);
  box-shadow: 0 20px 35px -5px rgba(37, 99, 235, 0.3);
}
